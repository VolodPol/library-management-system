...
/**
 * General strategy class for user validation
 */
public class UserStrategy implements ValidationStrategy {
    /**
     * User's data
     */
    protected final UserDataSet dataSet;
    /**
    ...
    public UserStrategy(UserDataSet dataSet){
        this.dataSet = dataSet;
    }

    /**
     * Implementation of validate() method, which checks if dataset is not
