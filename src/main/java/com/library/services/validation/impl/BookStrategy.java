...
/**
 * General strategy for book validation
 */
public class BookStrategy implements ValidationStrategy {
    /**
     * Contains book data
     */
     ...
     */
    public BookStrategy(BookDataSet dataSet) {
    ...
    public boolean validate() {
        ...
        if (!result)
            errorMessage = MessageName.INCORRECT_FORM;
        return result;
    }
    @Override
