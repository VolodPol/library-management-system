...
public interface MessageName {
    ...
    String EARLY_RETURN = "page.error_message.too_early_return";
    String OUT_OF_SHIFT = "page.error_message.out_of_shift";
    String MAX_TIME = "page.error_message.time_max_time";
